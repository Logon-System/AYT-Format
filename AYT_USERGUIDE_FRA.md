...
Si le tracker **Arkos Tracker**[^1] propose un export **YM**, il est également possible d'exporter directement des fichiers **AYT** à partir d'une version dérivée disponible ici:
