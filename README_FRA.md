...
Sauf à vouloir briller en société en prétendant avoir économisé **11 µsecondes** (ou **37 Tstates**), je vous conseille, si vous ne manipulez pas la pile dans votre code principal, de laisser cette option à 0. Cela vous évitera notamment de devoir sauvegarder et restituer le pointeur de pile, ce qui, in fine, vous ferait juste reperdre les 11 µsecondes gagnées.
...
On retrouve en général l'adresse de retour derrière l'appel du *player* (mais vous pouvez la mettre ailleurs).
