...
AYT_Builder_Start
    ...
    if PlayerAccessByJP
		...
		ld a,(hl)			; If empty list, initcode=ret
		ld (Ayt_InitCreate),a
...
Ayt_Player_B1b_Start
		ld c,#fe		; Ay IO Port Data Select (A0..A7)
Ayt_PatternIdx	equ $+1
		ld de,0
Ayt_Player_B1b_End
;-----------------------------------------------------------------------------------------------------------------------------------------------
Ayt_Player_B2_Start	
		out (#ff),a 		; Select Ay Idx 
...
Ayt_SendAY_r13				; <<<
		...
		out (#ff),a		; 11/00/00/00/11/00 Select R13 AY reg
