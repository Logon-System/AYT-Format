...
;;
;; I invite you to take the separate Builder version (which comes from the Winape assembler on Cpc) where there are some compilation directives
;; I had to merge the builder with the example to be able to assemble it (don't know how to do with zxspin assembler : no doc). 
;; There are probably minor adjustments to be made (& instead of # for hexadecimal values). 
;;
;; The snapshots are made with music originally composed on the CPC and whose frequency has been adapted for the ZX.
;; We hope you will enjoy them.
;;
;; Longshot / Logon System @ logon.system@free.fr
;;**********************************************************************************************************************************************
		org 16384
		incbin "AyTCedZX.bin"		; single screen. i guess better can be donne switching between page 5/7 and poking in attribute color map
;;
		org &8000
Start_Example
MAIN
...
;;**********************************************************************************************************************************************
AYT_File
;;		incbin "still_scrolling_export_zx_at2_noscrii.ayt"
		incbin "my-ai-is-dumb-last-zx.ayt"
End_Example
